...
const SocialIcons = ({ light = false }) => {
  const instagramIconResolver = useColorModeValue(
    instagramIcon,
    instagramIconLight
  );
  const facebookIconResolver = useColorModeValue(
    facebookIcon,
    facebookIconLight
  );
  ...
  return (
    <Flex
      ...
      // comment out w when add another social icon
      // w='58px'
    >
...
<a target="_blank" href="https://icons8.com/icon/QU5mfsH8tIqo/facebook">Facebook</a> icon by <a target="_blank" href="https://icons8.com">Icons8</a> */}
      <Link isExternal href="https://www.instagram.com/kulijana.rs/">
        <Image
          alt="instagram"
          src={light ? instagramIconLight.src : instagramIconResolver.src}
          width="25px"
        />
      </Link>
